      ...
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          <form onSubmit={onSubmit}>
            ...
            <div className="my-4 items-center flex before:border-t before:flex-1 before:border-gray-300 before:w-8 before:mt-2 after:border-t after:flex-1 after:border-gray-300 after:w-8 after:mt-2">
